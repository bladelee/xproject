...
RSpec.describe "Resource planner index", :js, :with_cuprite do
  ...
  it "redirects routes to upsale" do
    ...
    visit new_project_resource_planners_path(project)

    expect(page).to have_text "Upgrade now"

    visit project_resource_planner_path(project, id: "new")
