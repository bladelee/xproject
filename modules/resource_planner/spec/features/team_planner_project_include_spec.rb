...
RSpec.describe "Resource planner project include", :js, with_ee: %i[resource_planner_view] do
  shared_let(:enabled_modules) { %w[work_package_tracking resource_planner_view] }
  ...
  it_behaves_like "has a project include dropdown" do
    let(:work_package_view) { Pages::ResourcePlanner.new(project) }
